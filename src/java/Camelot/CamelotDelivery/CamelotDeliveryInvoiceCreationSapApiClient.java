 ...
 */
public class CamelotDeliveryInvoiceCreationSapApiClient {
    ...
    public String create() {
        try {
            ...
            // Step 2: Use session token to create Delivery Invoice
            createDeliveryInvoice(sessionId);
    ...
    private String loginToSAP() throws IOException {
        ...
        try {
            ...
            Logger.getLogger(CamelotDeliveryInvoiceCreationSapApiClient.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void createDeliveryInvoice(String sessionId) throws IOException {
        ...
        String jsonBody = "{"
                ...
                + "\"U_ClosingName\": \"CLOS001\","
                + "\"U_ClosingName2\": \"Jane Doe\","
                + "\"Series\": 1,"
                + "\"U_Packing\": \"Box\","
                + "\"U_ParcelType\": \"Standard\","
                + "\"U_Oxima\": \"TRUCK01\","
                + "\"DocumentLines\": ["
                + "    {"
                + "        \"ItemCode\": \"1271\","
        ...
        if (responseCode == 200 || responseCode == 204) {
            System.out.println(" Delivery Invoice Created Successfully");
        } else if (responseCode == 401) {
            System.out.println(" Session expired! Please re-login.");
        } else {
            System.out.println(" Delivery Invoice Creation Failed. Response: " + getErrorResponse(conn));
        }
    }
