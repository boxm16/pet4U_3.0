...
public class BarcodificationPrinter implements Printable {

    private int labelsCount;
    private int barcodesCount;

    public void setLabelsCount(int labelsCount) {
        this.labelsCount = labelsCount;
    }

    public void setBarcodesCount(int barcodesCount) {
    ...
    public int print(Graphics g, PageFormat pf, int page) throws PrinterException {
        ...
        * translate by the X and Y values in the PageFormat to avoid clipping
            ...
            g.drawString("HERE GOES COMMENT, NEAR BARCODE", 0, 30);
