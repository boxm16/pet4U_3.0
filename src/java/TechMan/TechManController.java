...
//-----------------------------------------------------------
    ...
    //---------------------------------------------------
    @RequestMapping(value = "/createCamelotNotesDatabaseTable", method = RequestMethod.GET)
    public String createCamelotNotesDatabaseTable(ModelMap modelMap) {
        String camelotNotesDatabaseTableResult = techManDao.createCamelotNotesDatabaseTable();
    ...
    @RequestMapping(value = "/deleteNotForEndoDatabaseTable1", method = RequestMethod.GET)
    ...
    //-----------------
    @RequestMapping(value = "/createEndoPackagingDatabaseTable", method = RequestMethod.GET)
    public String createEndoPackagingDatabaseTable(ModelMap modelMap) {
        String endoPackagingDatabaseTableResult = techManDao.createEndoPackagingDatabaseTable();

        endoPackagingDatabaseTableResult = endoPackagingDatabaseTableResult + "<br>";
    ...
    @RequestMapping(value = "/deleteShelvesReplenishmentDatabaseTable1", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/deleteEndoDeliveryDatabaseTables1", method = RequestMethod.GET)
