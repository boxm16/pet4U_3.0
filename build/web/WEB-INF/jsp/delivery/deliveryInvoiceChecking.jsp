...
<html>
    ...
    <center>
        ...
        <h3>Ημερομηνία Παραστατικού:${deliveryInvoice.insertionDate} </h3>
        <h3>Προμηθευτής:${deliveryInvoice.supplier} </h3>
        <h3>Αριθμός Παραστατικού:${deliveryInvoice.number} </h3>
        <hr>
