                ...
                <div class=" col-sm-4">
                    ...
                    <%
                        ...
                        for (Map.Entry<String, CamelotReplenishment> entrySet : orderedRreplenishmentsCardModeX.entrySet()) {
                            ...
                            out.println("<tr>");
                            out.println("<td colspan='2'>");
                            out.println("<a href='goForEditingCamelotReplenishment.htm?itemCode=" + replenishment.getCode() + "' target='_blank' class='btn btn-danger btn-sm d-inline' role='button' aria-disabled='true' ><h3>Edit<h3></a>");
                            out.println("</td>");
                            out.println("</tr>");
                            out.println("</tbody>");
                            out.println("</table>");
