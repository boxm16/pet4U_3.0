                ...
                <div class=" col-sm-4">
                    ...
                    <%
                        ...
                        for (Map.Entry<String, CamelotReplenishment> entrySet : orderedRreplenishmentsCardModeX.entrySet()) {
                            ...
                            out.println("<tr>");
                            out.println("<td colspan='2'>");
                            out.println("<center><a href='goForEditingCamelotReplenishment.htm?itemCode=" + replenishment.getCode() + "' target='_blank' class='btn btn-danger btn-sm'><h4>Edit<h4></a></center>");
                            out.println("</td>");
                            out.println("</tr>");
                            out.println("</tbody>");
                            out.println("</table>");
