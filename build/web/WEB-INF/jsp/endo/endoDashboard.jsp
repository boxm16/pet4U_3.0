            ...
            <tbody>
                <%     LinkedHashMap<String, BindedEndos> bindedEndos = (LinkedHashMap) request.getAttribute("bindedEndos");
                    ...
                    for (String strKey : alKeys) {
                        ...
                        out.println("<button style='width:100%; background-color: yellow; font-size:20px;' onclick=\"location.href='showbindedEndos.htm?binderId="+strKey+"'\" type=\"button\"><h3>See Binded Endos</h3></button>");
                        out.println("</td>");
                        out.println("</tr>");
