    ...
    <body>
        ...
        <div class="container">
            <center>
                ...
                ΣΗΜΑΝΤΙΚΗ ΕΠΙΣΗΜΑΝΣΗ. Εδώ είναι όλοι οι κωδικοί ΠΟΥ ΜΟΥ ΕΡΧΟΝΤΑΙ ΜΕΣΩ VIEW. Που είναι περίπου 1/3 από ΟΛΟΥΣ τους κωδικούς. Οι υπόλοιπου 2/3 κατά (περιπου) 90%  είναι  πλέον άχρηστοι(ανενεργοί).Αλλά τα (περιπου) 10% είναι "ζωντανοι". Ζήτησα πολλές φορές να μου έρχονται ΟΛΑ,  αλλά για κάποιο λόγο λίγο δυσκολεύετε ο Βασίλης να μου το φτιάξει.
                <br>
