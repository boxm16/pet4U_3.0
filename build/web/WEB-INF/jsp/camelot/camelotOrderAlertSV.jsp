...
<html>
    ...
    <center>
        ...
        <hr>
        <h1 style="background-color: red">Billy, ξεχασα να κοψω επιστροφη για ΜΠΟΥΤΟ, τα έχω πίσω από τη καρέκλα μου, σ`ένα κουτί, 6 τεμαχια hairball ληγμένα (νομιζω ο κωδικος ειναι 22.01.030) και 1 τεμαχια 5-οκιλο ND (κωδικό δε ξέρω, μαζί είναι). Αν ερθει πριν ερθω εγω, κοψε(η πες στον Δημητρη) και δοσε. Επισης, Πασσαλης θα φέρει μεγάλη παραγγελια, ας την σε εμαν. Θα τγν κανω εγώ όταν έρθω ( </h1>
  <hr>
        <table>
            <thead>
            <th>Position</th>
