...
<html>
    ...
    <center>
        ...
        <hr>
        <h1 style="background-color: blue">BillyΚουτια της ROYAL και τετραγωνα και μακροστενα θελει ο κυριος Γιωργος. Μη τα παρει κανεις. Αλλο, αν ο κωδικός 21.01.082 υπάρχει στο ράφι (στη θεση 10Ε-09-112) και έχει ήμερ. λήξης 1.25  ,βγάλε από το ράφι.   </h1><hr>
        <table>
            <thead>
            <th>Position</th>
