                ...
                <div class=" col-sm-4">
                    ...
                    <center>
                        ...
                        <% if (item != null) {
                                ...
                                out.println("<td>");
                                out.println(" <a href='printMainBarcodeX.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' aria-disabled='true' style='background-color: #d67965'><h3>PRINT<br>MAIN<br>BARCODE</h3></a>");
                                out.println("</td>");
                                out.println("</tr>");
                                out.println("</tbody>");
                                out.println("</table>");
