                ...
                <div class=" col-sm-4">
                    ...
                    <center>
                        ...
                        <% if (item != null) {
                                ...
                                out.println("<hr>");
                                out.println("<hr>");
                                out.println(" <a style='display: inline' href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' aria-disabled='true'><h3>PRINT LABEL</h3></a>"
                                        + "<a style='display: inline' href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' aria-disabled='true'><h3>PRINT LABEL</h3></a>");
                                //  out.println("<hr>");
