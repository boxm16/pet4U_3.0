                ...
                <div class=" col-sm-4">
                    ...
                    <center>
                        ...
                        <% if (item != null) {
                                ...
                                out.println("<hr>");
                                out.println("<hr>");
                                out.println(" <a  href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' aria-disabled='true'><h3 style='display: inline'>PRINT LABEL</h3></a>"
                                        + "<a  href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' aria-disabled='true'><h3 style='display: inline'>PRINT LABEL</h3></a>");
                                //  out.println("<hr>");
