                ...
                <div class=" col-sm-4">
                    ...
                    <center>
                        ...
                        <% if (item != null) {
                                ...
                                out.println("<hr>");
                                out.println("<hr>");
                                out.println(" <a href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' ><h3>PRINT LABEL</h3></a>"
                                        + "<a href='printBarcode.htm?altercode=" + target + "' class='btn btn-danger btn-lg' role='button' ><h3>PRINT LABEL</h3></a>");
                                //  out.println("<hr>");
