...
<html>
    <head>
        ...
        <style>
            ...
            /* Input colors in highlighted rows */
            ...
            /* Readonly inputs in highlighted rows */
    ...
    <script type="text/javascript">
        ...
        function addRow(code, description) {
            ...
            c4.innerText = "1";
            c5.innerHTML = "<input class='deliveredPackages' type='number' id='" + code + "_deliveredPackages' value='0'>";
