...
<html>
    ...
    <center>
        ...
        <h1 style="background-color: red">Billy,  καλημέρα. <br> 
            Νομίζω, νομίζω ξέχασα το ηλεκτρικο παλετοφόρο (το δυνατό, όχι ανυψωτικό) ανοιχτό. Για 2 μέρες μπορεί να του πέσει πολυ η μπαταρία. Αν όντως το ξέχασα, βάλε για φώρτηση(Αν μπαταρία έπεσε τελείως, και δε κουνιέτε, ε , πάρε με τηλέφωνο να έρθω και κάτι θα κάνουμε να το πάμε μέχρι την πρίζα. <br> Επίσης, Πασσαλής (πιθανών) θα έρθει σήμερα, + ROYAL μεγάλη παραλαβή, άστα και τα τα δύο για μένα</h1>
