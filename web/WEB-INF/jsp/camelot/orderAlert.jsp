...
<html>
    ...
    <center>
        ...
        <hr>
        <h1>BILLY, κωδικός 06.17.0970, θεση 01Π-16-1, 2 τεμάχια ACANA που έχουμε εκεί, πρέπει να βγούνε ετικέτες προσφοράς(-10 ευρο), Τελείωσε η προσφορά.
            <br>P.S. το ίδα από το σπίτ, αλλιώς θα το έκανα εγώ.
        </h1>
        <table>
            <thead>
            <th>Owner</th>
